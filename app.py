...
class MyToolbarApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.remove_widget_action = Action(QIcon("sources/delete_pen.png"), "Remove Pens", self) 
    ...
    def create_change_thickness_button(self):
        ...
        menu.addActions([
            Action(QIcon("sources/1px.png"), '1px', triggered=lambda _, thickness=1 : self.change_thickness(thickness)),
            Action(QIcon("sources/3px.png"), '3px', triggered=lambda _, thickness=3 : self.change_thickness(thickness)),
            Action(QIcon("sources/5px.png"), '5px', triggered=lambda _, thickness=5 : self.change_thickness(thickness)),
            Action(QIcon("sources/7px.png"), '7px', triggered=lambda _, thickness=7 : self.change_thickness(thickness)),
            Action(QIcon("sources/9px.png"), '9px', triggered=lambda _, thickness=9 : self.change_thickness(thickness)),
        ]) 
    ...
    def create_toolbar_actions(self):
        ...
        for action_text, action_value in self.__LIST_OF_PEN.items():
            action = Action(QIcon(f"sources/pen_{index}.svg"), action_value, checkable=True)
    ...
    def add_widgets_to_toolbar(self):
        ...
        if color is not None:
            ...
            new_widget = Action(QIcon(f"sources/pen_{index}.svg"), color, checkable=True)
