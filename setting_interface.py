...
class SettingInterface(ScrollArea):
    ...
    def __init__(self, parent=None):
        ...
        # pens setting
        self.penGroup = SettingCardGroup(self.tr('Pens'), self.scrollWidget)

        # Pen Colors
        self.StrokeSizeCard = RangeSettingCard(
            cfg.StrokeSize,
            FIF.HIGHTLIGHT,
            self.tr('Stroke size'),
            parent=self.penGroup
        )
        ...
        self.minimizeToTrayCard = SwitchSettingCard(
            ...
            self.tr('Painto will continue to run in the background'),
    ...
    def __initLayout(self):
        ...
        self.expandLayout.addWidget(self.penGroup)
    ...
    # def __strokeSizeChanged(self, size:int):
    #     self.strokeSizeChanged.emit(size)
    ...
    def __connectSignalToSlot(self):
        ...
        # Pens 
        # self.StrokeSizeCard.valueChanged.connect(self.__strokeSizeChanged)
